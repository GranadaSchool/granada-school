        ...
        <div style={{width:"clamp(180px,25vw,260px)",flexShrink:0,borderRight:"1px solid rgba(255,255,255,0.1)",overflowY:"auto",padding:"1.5rem 0",background:"rgba(0,0,0,0.2)"}}>
          {NAV_ITEMS.map((item,i)=>(
            <button key={item.label} onMouseEnter={()=>setActive(i)} onClick={()=>setActive(i)}
              ...
              <span style={{fontSize:"clamp(0.75rem,1.02vw,0.82rem)",fontWeight:active===i?700:400,letterSpacing:"0.06em",textTransform:"uppercase",color:active===i?S:"#fff",fontFamily:"inherit",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{item.label}</span>
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",borderRight:"1px solid rgba(255,255,255,0.1)",background:"#213558"}}>
            ...
            <div style={{flex:1,overflowY:"auto",padding:"1.25rem 1.5rem"}}>
              {cur.children?.map((child,i)=>(
                <a key={i} href={child.href} onClick={onClose} style={{display:"flex",alignItems:"center",gap:"0.6rem",padding:"0.5rem 0",color:"#fff",textDecoration:"none",fontSize:"clamp(0.75rem,1.02vw,0.82rem)",borderBottom:"1px solid rgba(255,255,255,0.1)",transition:"color 0.2s"}}
...
function PageHero(){
  ...
  return(
    <section style={{position:"relative",height:"100vh",minHeight:600,overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",inset:0,background:"linear-gradient(135deg,rgba(74,100,40,0.88) 0%,rgba(33,53,88,0.65) 55%,rgba(13,12,13,0.45) 100%)"}}/>
      ...
      <div style={{position:"relative",zIndex:5,height:"100%",maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",paddingTop:"clamp(140px,16vw,165px)",display:"flex",flexDirection:"column",paddingBottom:"clamp(6rem,4vw,8rem)"}} className="hero-inner">
        ...
        <div style={{display:"flex",alignItems:"center",gap:"0.45rem",marginBottom:"1.1rem",opacity:loaded?1:0,transition:"all 0.7s ease 0.2s",flexWrap:"wrap"}}>
          {[{label:"Granada",href:"/"},{label:"CBE",href:"/granada-school"},{label:"Wellbeing",href:"/granada-school/wellbeing"}].map((bc,i)=>(
        ...
        <div style={{display:"flex",alignItems:"flex-end",gap:"clamp(2rem,4vw,3.5rem)"}} className="hero-content">
          <div style={{flex:1,minWidth:280}}>
            <p style={{color:"var(--secondary)",textTransform:"uppercase",letterSpacing:"0.28em",fontSize:"clamp(0.55rem,0.78vw,0.62rem)",fontWeight:700,marginBottom:"0.55rem",opacity:loaded?1:0,transition:"all 0.7s ease 0.3s"}}>Pastoral Care & Wellbeing</p>
            <h1 className="font-display" style={{fontSize:"clamp(2.4rem,5.5vw,4.8rem)",fontWeight:600,lineHeight:1.02,color:"#fff",marginBottom:"0.5rem",opacity:loaded?1:0,transform:loaded?"none":"translateY(20px)",transition:"all 0.8s ease 0.4s"}}>
              Nurturing the<br/><span style={{color:"var(--accent-light)"}}>Whole Girl</span>
            </h1>
            ...
            <p style={{color:"rgba(255,255,255,0.82)",fontSize:"clamp(0.84rem,1.2vw,1rem)",fontWeight:300,maxWidth:480,lineHeight:1.82,opacity:loaded?1:0,transform:loaded?"none":"translateY(18px)",transition:"all 0.8s ease 0.55s"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:"0.9rem",flexShrink:0,opacity:loaded?1:0,transition:"opacity 0.9s ease 0.7s"}}>
            <a href="#approach" className="btn-green" style={{fontSize:"clamp(0.62rem,0.88vw,0.7rem)",padding:"0.75rem 2rem",textAlign:"center"}}>Our Approach</a>
            <a href="/granada-school/admissions" style={{display:"inline-block",padding:"0.75rem 2rem",background:"transparent",border:"1px solid rgba(255,255,255,0.6)",color:"#fff",textTransform:"uppercase",letterSpacing:"0.14em",fontSize:"clamp(0.62rem,0.88vw,0.7rem)",fontWeight:600,textDecoration:"none",transition:"all 0.3s",textAlign:"center"}}
...
function WellbeingApproach(){
  ...
  const pillars=[
    ...
    {title:"Physical Wellness",desc:"A structured schedule of physical activity, nutritious meals, and rest ensures each student maintains energy, health, and the strength to perform at their best.",icon:"🏃",color:"#213558"},
    ...
    <section id="approach" ref={ref} className="section-cream" style={{padding:"clamp(3rem,6vw,6rem) clamp(1rem,2vw,2rem)",scrollMarginTop:"100px"}}>
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        <div className="section-header-block" style={{textAlign:"center",marginBottom:"clamp(2rem,4vw,3.5rem)",opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.8s ease"}}>
          ...
          <p className="body-text">Wellbeing isn't a department at Granada — it's woven into everything we do, every day, for every girl.</p>
        </div>
...
function CounsellingSection(){
  ...
  return(
    <section id="counselling" ref={ref} className="section-blue" style={{padding:"clamp(3rem,6vw,6rem) clamp(1rem,2vw,2rem)",scrollMarginTop:"100px"}}>
      ...
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        <div className="section-float-img" style={{float:"right",margin:"0 0 1.2rem 1.5rem",width:"clamp(280px,38vw,420px)",opacity:vis?1:0,transform:vis?"none":"translateY(28px)",transition:"all 0.9s ease 0.2s",display:"grid",gridTemplateColumns:"1fr 1fr",gridTemplateRows:"clamp(200px,26vw,280px) clamp(130px,17vw,170px)",gap:"10px"}}>
          {[
            ...
            <div key={i} className="img-hover" style={{gridColumn:img.col,gridRow:img.row,overflow:"hidden",position:"relative"}}>
              ...
              <div style={{position:"absolute",inset:0,background:"linear-gradient(to top,rgba(33,53,88,0.4),transparent 65%)"}}/>
            </div>
          ))}
        </div>
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(-28px)",transition:"all 0.9s ease"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"1rem",clear:"both"}}>
            {[
              ...
              <div key={i} style={{padding:"1rem",border:"1px solid rgba(255,255,255,0.15)",background:"rgba(255,255,255,0.06)",opacity:vis?1:0,transform:vis?"none":"translateY(12px)",transition:`all 0.7s ease ${0.3+i*0.1}s`}}>
                <p style={{color:"var(--secondary)",fontSize:"clamp(0.55rem,0.78vw,0.62rem)",fontWeight:700,letterSpacing:"0.14em",textTransform:"uppercase",marginBottom:"0.3rem"}}>{s.label}</p>
                <p style={{color:"rgba(255,255,255,0.72)",fontSize:"clamp(0.72rem,1vw,0.8rem)",lineHeight:1.6}}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <section id="character" ref={ref} className="section-cream" style={{padding:"clamp(3rem,6vw,6rem) clamp(1rem,2vw,2rem)",scrollMarginTop:"100px"}}>
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        <div className="section-header-block" style={{textAlign:"center",marginBottom:"clamp(2rem,4vw,3.5rem)",opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.8s ease"}}>
          ...
          <div className="divider" style={{margin:"1.25rem auto"}}/>
          <p className="body-text">Our values aren't a list on a wall — they are lived daily, celebrated continuously, and woven into the fabric of every experience at Granada.</p>
        </div>
  ...
  return(
    <section id="global" ref={ref} style={{position:"relative",padding:"clamp(3.5rem,7vw,7rem) clamp(1rem,2vw,2rem)",overflow:"hidden",scrollMarginTop:"100px"}}>
      ...
      <div style={{position:"relative",zIndex:2,maxWidth:1280,margin:"0 auto"}}>
        <div className="section-float-img" style={{float:"right",margin:"0 0 1.2rem 1.5rem",width:"clamp(280px,38vw,420px)",opacity:vis?1:0,transform:vis?"none":"translateY(28px)",transition:"all 0.9s ease 0.2s"}}>
          <div className="img-hover" style={{overflow:"hidden",minHeight:"clamp(300px,38vw,460px)",height:"100%",position:"relative"}}>
        ...
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(-28px)",transition:"all 0.9s ease"}}>
          <p style={{color:"var(--secondary)",textTransform:"uppercase",letterSpacing:"0.28em",fontSize:"clamp(0.56rem,0.8vw,0.65rem)",fontWeight:700,marginBottom:"1.1rem"}}>Global Citizenship</p>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:"0.6rem",clear:"both"}}>
            {["Community Service","Environmental Stewardship","Cultural Appreciation","Debate & Public Speaking","Social Justice Awareness","SDG Projects"].map((tag,i)=>(
              <span key={i} style={{padding:"0.35rem 0.9rem",border:"1px solid rgba(170,194,12,0.4)",color:"var(--secondary)",fontSize:"clamp(0.62rem,0.88vw,0.7rem)",letterSpacing:"0.08em",transition:"all 0.25s",cursor:"default"}}
