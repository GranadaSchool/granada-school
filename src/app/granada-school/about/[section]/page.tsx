...
function SideNav({open,onClose}:{open:boolean;onClose:()=>void}){
  ...
  return(<>
    ...
    <div style={{position:"fixed",top:0,right:0,bottom:0,zIndex:200,width:"100%",maxWidth:900,display:"flex",flexDirection:"column",background:"#213558",transform:open?"translateX(0)":"translateX(100%)",transition:"transform 0.5s cubic-bezier(0.77,0,0.175,1)",boxShadow:"-8px 0 60px rgba(0,0,0,0.3)"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"clamp(0.8rem,1.5vw,1.1rem) clamp(1rem,2.5vw,2.5rem)",borderBottom:"1px solid rgba(255,255,255,0.1)",flexShrink:0,gap:"1.5rem",background:"rgba(0,0,0,0.2)",flexWrap:"wrap"}}>
        ...
        <div style={{flex:1,maxWidth:280,position:"relative"}}>
          <input type="text" placeholder="Search…" value={search} onChange={e=>setSearch(e.target.value)} onFocus={()=>setSf(true)} onBlur={()=>setTimeout(()=>setSf(false),150)}
            style={{width:"100%",background:"#fff",border:`1px solid ${sf?P:"#dddbd8"}`,color:"#1c1b1c",padding:"0.45rem 2rem 0.45rem 0.8rem",fontSize:"clamp(0.72rem,1vw,0.8rem)",outline:"none",transition:"border-color 0.2s",fontFamily:"inherit"}}/>
          <span style={{position:"absolute",right:"0.7rem",top:"50%",transform:"translateY(-50%)",color:"#aaa",fontSize:"clamp(0.78rem,1.1vw,0.88rem)",pointerEvents:"none"}}>⌕</span>
        ...
        <div style={{width:"clamp(120px,22vw,260px)",flexShrink:0,borderRight:"1px solid rgba(255,255,255,0.1)",overflowY:"auto",padding:"1.5rem 0",background:"rgba(0,0,0,0.2)"}}>
          {NAV_ITEMS.map((item,i)=>(
            <button key={item.label} onMouseEnter={()=>setActive(i)} onClick={()=>setActive(i)}
              ...
              <span style={{fontSize:"clamp(0.75rem,1.02vw,0.82rem)",fontWeight:active===i?700:400,letterSpacing:"0.06em",textTransform:"uppercase",color:active===i?S:"#fff",transition:"color 0.2s",fontFamily:"inherit"}}>{item.label}</span>
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",borderRight:"1px solid rgba(255,255,255,0.1)",background:"#213558"}}>
            ...
            <div style={{flex:1,overflowY:"auto",padding:"1.25rem 1.5rem"}}>
              ...
              <div style={{display:"flex",gap:"0.6rem",marginTop:"1.5rem",flexWrap:"wrap"}}>
                <a href="/granada-school/contact" onClick={onClose} style={{fontSize:"clamp(0.55rem,0.78vw,0.62rem)",padding:"0.45rem 1.2rem",background:S,color:P,textDecoration:"none",border:"none",cursor:"pointer",transition:"all 0.2s"}} onMouseEnter={e=>(e.currentTarget.style.opacity="0.9")} onMouseLeave={e=>(e.currentTarget.style.opacity="1")}>Enquire</a>
                <a href="/granada-school/contact?type=admissions" onClick={onClose} style={{fontSize:"clamp(0.55rem,0.78vw,0.62rem)",padding:"0.45rem 1.2rem",background:"transparent",color:"#fff",border:`1px solid ${S}`,textDecoration:"none",cursor:"pointer",transition:"all 0.2s"}} onMouseEnter={e=>{e.currentTarget.style.background=S;e.currentTarget.style.color=P;}} onMouseLeave={e=>{e.currentTarget.style.background="transparent";e.currentTarget.style.color="#fff";}}>Apply Now</a>
              </div>
            </div>
          </div>
          {/* Right column - Image */}
...
function PageHero(){
  ...
  return(
    <section style={{position:"relative",height:"100vh",minHeight:600,overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",inset:0,background:"linear-gradient(to right,rgba(33,53,88,0.82) 40%,rgba(33,53,88,0.3) 100%)"}}/>
      ...
      <div style={{position:"relative",zIndex:5,height:"100%",maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",paddingTop:"clamp(140px,16vw,165px)",display:"flex",flexDirection:"column",paddingBottom:"clamp(6rem,4vw,8rem)"}} className="hero-inner">
        ...
        <div style={{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"clamp(0.8rem,1.5vw,1.25rem)",opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(10px)",transition:"all 0.6s ease 0.2s"}}>
          {[{label:"Granada",href:"/"},{label:"CBE",href:"/granada-school"},{label:"About",href:"/granada-school/about"}].map((bc,i)=>(
            <span key={i} style={{display:"flex",alignItems:"center",gap:"0.5rem"}}>
              <a href={bc.href} style={{color:"rgba(255,255,255,0.65)",textDecoration:"none",fontSize:"clamp(0.6rem,1vw,0.68rem)",letterSpacing:"0.12em",textTransform:"uppercase",transition:"color 0.2s"}}
                onMouseEnter={e=>(e.currentTarget.style.color="#fff")} onMouseLeave={e=>(e.currentTarget.style.color="rgba(255,255,255,0.65)")}>{bc.label}</a>
        ...
        <h1 className="font-display" style={{fontSize:"clamp(2.6rem,5.5vw,4.5rem)",fontWeight:600,lineHeight:1.05,color:"#fff",marginBottom:"0.8rem",opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(20px)",transition:"all 0.8s ease 0.4s"}}>
          A Vibrant Learning<br/><span style={{color:"var(--accent-light)"}}>Community</span>
        </h1>
...
function Welcome(){
  ...
  return(
    <section className="section-cream" id="welcome" ref={ref} style={{paddingTop:"clamp(3rem,6vw,5rem)",paddingBottom:"clamp(3rem,6vw,5rem)",scrollMarginTop:"100px"}}>
      ...
      <div>
        <div className="section-float-img" style={{float:"right",margin:"0 0 1.2rem 1.5rem",width:"clamp(280px,38vw,420px)",opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.9s ease 0.2s"}}>
          <div style={{position:"relative",overflow:"hidden",minHeight:"clamp(280px,40vw,400px)"}} className="img-hover">
          ...
          <div style={{borderLeft:"3px solid var(--primary)",paddingLeft:"clamp(0.8rem,1.5vw,1.2rem)",paddingTop:"clamp(0.9rem,1.5vw,1.4rem)"}}>
            ...
            <p style={{color:"var(--primary)",fontSize:"clamp(0.6rem,0.75vw,0.68rem)",letterSpacing:"0.14em",textTransform:"uppercase",fontWeight:700}}>
              The Principal<br/><span style={{color:"var(--muted)",fontWeight:400,textTransform:"none",letterSpacing:"normal",fontSize:"clamp(0.75rem,1.02vw,0.82rem)"}}>Granada School</span>
            </p>
          </div>
        </div>
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:"all 0.9s ease 0.1s"}}>
          ...
          <div style={{display:"flex",gap:"0.75rem",flexWrap:"wrap",clear:"both"}}>
            <a href="/granada-school/contact" className="btn-solid">Enquire Now</a>
  ...
  return(
    <section className="section-cream" id="history" ref={ref} style={{paddingTop:"clamp(3rem,6vw,5rem)",paddingBottom:"clamp(3rem,6vw,5rem)",scrollMarginTop:"100px"}}>
      ...
      <div>
        ...
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.9s ease 0.15s"}}>
    ...
    <section className="section-blue" id="boarding" ref={ref} style={{paddingTop:"clamp(3rem,6vw,5rem)",paddingBottom:"clamp(3rem,6vw,5rem)",scrollMarginTop:"100px"}}>
      ...
      <div className="section-header-block" style={{opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.8s ease"}}>
        ...
        <div style={{opacity:vis?1:0,transition:"all 0.9s ease"}}>
          <div className="section-float-img" style={{float:"right",margin:"0 0 1.2rem 1.5rem",width:"clamp(280px,38vw,420px)",opacity:vis?1:0,transform:vis?"none":"translateX(24px)",transition:"all 0.9s ease 0.15s"}}>
            <div className="img-hover" style={{overflow:"hidden",minHeight:"clamp(300px,50vw,420px)",height:"100%"}}>
          ...
          <a href="/granada-school/contact?type=admissions" className="btn-solid" style={{clear:"both",display:"inline-block"}}>Enquire About Boarding</a>
        </div>

      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"1px",background:"rgba(255,255,255,0.12)",opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:"all 0.9s ease 0.25s",clear:"both",marginTop:"clamp(2rem,3vw,3rem)"}}>
        {[
