...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Music', href: '/campus-life/music' },
      {
        label: 'Co-Curricular',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Core Values', href: '/wellbeing/values' },
      {
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Social Media', href: '/news/social' },
    ],
  },
  {
    label: 'Parents',
    ...
    children: [
      ...
      { label: 'Term Dates', href: '/#contact' },
      { label: 'Reports & Policies', href: '/#contact' },
    ],
  },
  {
    label: 'Support Us',
...
const CURRICULUM_OPTIONS = [
  ...
  { value: 'edexcel', label: 'International (Edexcel)' },
  { value: 'cambridge', label: 'International (Cambridge / CAIE)' },
];
